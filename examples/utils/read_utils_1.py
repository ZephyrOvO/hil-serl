...
def get_frame_data(frame_path, robot_urdf_path, enable_tactile=False):
    ...
    index_heat_map_path = os.path.join(frame_path, "rindex_raw_image.jpg")
    thumb_heat_map_path = os.path.join(frame_path, "rthumb_raw_image.jpg")
    middle_heat_map_path = os.path.join(frame_path, "rmiddle_raw_image.jpg")
